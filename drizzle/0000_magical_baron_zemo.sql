...
--> statement-breakpoint
CREATE TABLE "agentforge_post" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "agentforge_post_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256),
...
CREATE INDEX "kb_chunks_agent_idx" ON "agentforge_kb_chunks" USING btree ("agent_id");--> statement-breakpoint
CREATE INDEX "name_idx" ON "agentforge_post" USING btree ("name");